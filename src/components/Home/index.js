  ...
  return (
    <div className='home'>
        ...
        <div className='home__description'>
          <p className='home__item'>Vous etes sur la premiere version de notre site.</p>
          ...
          <p className='home__item'>Nous effectuons les livraisons quotidiennes 6j/7 dans Paris et sa région.</p>
